...
```
Looks like there is a trend: Temp0?, Temp700Lag28?, SSH0Lag7?, GSDist, Sal0Lag56, Sal700Lag7,
  VelMag0Lag21, VelMag700Lag56, VelAsp0Lag21, VelAsp700Lag7, Chl0, Slope, Aspect

Looks like there is no trend: FSLE0Lag28, GSLatLag28
...
```
GSDist is pretty collinear with SSH, and a bit with Temp700 and Sal700
SSH collinear with Temp700, Sal700, and slightly with Chl0
Temp700 and Sal700 slightly collinear with each other, remove one
```{r smooth vs linear}
