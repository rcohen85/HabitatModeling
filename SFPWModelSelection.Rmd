...
```
Looks like there is a trend: Temp0?, Temp700Lag28?, SSH0Lag7?, GSDist

Looks like there is no trend: Sal0Lag56, Sal700Lag7, VelMag0Lag21, VelMag700Lag56, VelAsp0Lag21,
  VelAsp700Lag7, Chl0, FSLE0Lag28, GSLatLag28, Slope, Aspect
...
```
remove the covars that show no relationship in graph
remove SSH because it is colinear with the temps
```{r smooth vs linear}
