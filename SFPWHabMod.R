...
for (j in 1:length(sites)){
  ...
  if (sum(which(weeklyDF$Pres[siteInd]>0))>10){
    ...
    BlockMod = glm(Pres~bs(CEddyDist0)
                   + bs(AEddyDist0) # include all terms in smoothVarList above!!
                   + bs(EKE0)
                   + bs(Chl0)
                   + bs(Sal0)
                   + bs(SSH0)
...
#                 para s(AEddyDist0) s(CEddyDist0) s(EKE0) s(Chl0) s(Sal0) s(SSH0) s(Temp0)
# para             1        0.0000        0.0000  0.0000  0.0000  0.0000  0.0000   0.0000
# s(AEddyDist0)    0        1.0000        0.0058  0.0074  0.0234  0.0606  0.1897   0.0234
# s(CEddyDist0)    0        0.0244        1.0000  0.0230  0.0404  0.1824  0.1974   0.1164
# s(EKE0)          0        0.0126        0.0403  1.0000  0.0086  0.1266  0.0496   0.0377
# s(Chl0)          0        0.1060        0.1138  0.0113  1.0000  0.3332  0.6354   0.5345
# s(Sal0)          0        0.1933        0.1899  0.0449  0.1790  1.0000  0.6840   0.4449
# s(SSH0)          0        0.1805        0.1906  0.0298  0.2239  0.4942  1.0000   0.6452
# s(Temp0)         0        0.1143        0.0989  0.0211  0.2647  0.3406  0.4541   1.0000

# SSH0 concurved w Chl0, Sal0
# Temp400 concurved with Chl0, SSH0
...
#                 para s(AEddyDist0) s(CEddyDist0) s(EKE0) s(Chl0) s(Sal0) s(Temp0)
# para             1        0.0000        0.0000  0.0000  0.0000  0.0000   0.0000
# s(AEddyDist0)    0        1.0000        0.0058  0.0074  0.0234  0.0606   0.0234
# s(CEddyDist0)    0        0.0244        1.0000  0.0230  0.0404  0.1824   0.1164
# s(EKE0)          0        0.0126        0.0403  1.0000  0.0086  0.1266   0.0377
# s(Chl0)          0        0.1060        0.1138  0.0113  1.0000  0.3332   0.5345
# s(Sal0)          0        0.1933        0.1899  0.0449  0.1790  1.0000   0.4449
# s(Temp0)         0        0.1143        0.0989  0.0211  0.2647  0.3406   1.0000

# Chl0 still concurved w Temp0
# removing Chl0
...
#                 para s(AEddyDist0) s(CEddyDist0) s(EKE0) s(Sal0) s(Temp0)
# para             1        0.0000        0.0000  0.0000  0.0000   0.0000
# s(AEddyDist0)    0        1.0000        0.0058  0.0074  0.0606   0.0234
# s(CEddyDist0)    0        0.0244        1.0000  0.0230  0.1824   0.1164
# s(EKE0)          0        0.0126        0.0403  1.0000  0.1266   0.0377
# s(Sal0)          0        0.1933        0.1899  0.0449  1.0000   0.4449
# s(Temp0)         0        0.1143        0.0989  0.0211  0.3406   1.0000
