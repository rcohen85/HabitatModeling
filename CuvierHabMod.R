...
weekMod = gam(Pres ~ s(sqrt_CEddyDist0,bs="ts")
              ...
              + s(Temp0,bs="ts")
              + s(Temp700,bs="ts")
              + s(sqrt_VelAsp0,bs="cc",k=4) #cyclic smooth
              + s(VelMag0,bs="ts"),
              data=weeklyDF,
              family=modFam,
              method="REML",
...
# Parametric coefficients:
#   Estimate Std. Error t value Pr(>|t|)    
# (Intercept)  1.60044    0.04865   32.89   <2e-16 ***
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Approximate significance of smooth terms:
#   edf Ref.df      F  p-value    
# s(sqrt_CEddyDist0) 1.939e+00      9  3.379  < 2e-16 ***
#   s(sqrt_EKE0)       7.370e-01      9  0.421 0.017108 *  
#   s(log_abs_FSLE0)   2.778e-03      9  0.000 0.822580    
# s(Sal0)            3.286e-05      9  0.000 0.852125    
# s(Sal700)          4.259e+00      9  5.246  < 2e-16 ***
#   s(SSH0)            7.972e+00      9 84.028  < 2e-16 ***
#   s(Temp0)           9.364e-01      9  1.153 0.000521 ***
#   s(Temp700)         6.759e+00      9  5.455  < 2e-16 ***
#   s(sqrt_VelAsp0)    1.429e+00      2  4.541 0.001669 ** 
#   s(VelMag0)         2.727e+00      9  1.825 0.000168 ***
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# R-sq.(adj) =  0.647   Deviance explained =   70%
# -REML = 3004.6  Scale est. = 5.5282    n = 1509
...
# Sal0, Sa700, Temp0, Temp700, SSH0 all highly concurved
# VelMag0 moderately concurved w SSH0
# Taking out Sal0 (non-sig), Temp700, SSH0
...
#                     para s(sqrt_CEddyDist0) s(sqrt_EKE0) s(log_abs_FSLE0) s(Sal700) s(Temp0) s(sqrt_VelAsp0) s(VelMag0)
# para                  1             0.0000       0.0000           0.0000    0.0000   0.0000          0.0000     0.0000
# s(sqrt_CEddyDist0)    0             1.0000       0.0345           0.0817    0.2504   0.1701          0.1458     0.1696
# s(sqrt_EKE0)          0             0.0380       1.0000           0.0731    0.0523   0.0175          0.0370     0.0546
# s(log_abs_FSLE0)      0             0.0862       0.0436           1.0000    0.2125   0.1481          0.2437     0.2651
# s(Sal700)             0             0.2448       0.0588           0.2205    1.0000   0.5328          0.4682     0.4233
# s(Temp0)              0             0.1536       0.0189           0.0995    0.5166   1.0000          0.2495     0.1460
# s(sqrt_VelAsp0)       0             0.1095       0.0225           0.1713    0.3098   0.2321          1.0000     0.3995
# s(VelMag0)            0             0.1232       0.1505           0.1792    0.2269   0.1806          0.3999     1.0000

# Sal700 and Temp0 slightly concurved, but leaving both in
