...
data = data.frame(read.csv('E:/ModelingCovarData/Master_DFs/Risso_masterDF.csv'))
lagID = 126
...
```
Looks like there may be a trend: Temp0Lag56, Temp400Lag56, Sal0Lag28, Sal400Lag56, 
  VelMag400Lag56, VelAsp0Lag7, VelAsp400, SSH0Lag21, Chl0Lag56, FSLE0Lag7, GSDist, Slope, Aspect

Looks like no trend: VelMag0Lag56, FSLE0Lag7, GSLatLag7
...
```
Remove SSH, collinear with temp and salinity
Temp400 and Sal400 are really collinear with each other, Temp0 and Temp400 also appear to be collinear even though the
  plots don't really show this? needs more investigation
```{r smooth vs linear}
