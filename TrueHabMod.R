...
# run full model
weekMod = gam(Pres ~ s(FSLE0,bs="ts",k=4)
              + s(EKE0,bs="ts",k=4)
              + s(Sal0,bs="ts",k=4)
              + s(SSH0,bs="ts",k=4)
              + s(Temp0,bs="ts",k=4)
...
#             para s(FSLE0) s(EKE0) s(Sal0) s(SSH0) s(Temp0) s(VelMag0)
# para          1   0.0000  0.0000  0.0000  0.0000   0.0000     0.0000
# s(FSLE0)      0   1.0000  0.0259  0.2263  0.1687   0.1374     0.2002
# s(EKE0)       0   0.0366  1.0000  0.1266  0.0496   0.0377     0.0862
# s(Sal0)       0   0.1182  0.0449  1.0000  0.6840   0.4449     0.2912
# s(SSH0)       0   0.1005  0.0298  0.4942  1.0000   0.6452     0.3969
# s(Temp0)      0   0.0694  0.0211  0.3406  0.4541   1.0000     0.2363
# s(VelMag0)    0   0.1570  0.0689  0.3295  0.1107   0.2374     1.0000

# SSH0 concurved w Sal0
...
#             para s(FSLE0) s(EKE0) s(Sal0) s(Temp0) s(VelMag0)
# para          1   0.0000  0.0000  0.0000   0.0000     0.0000
# s(FSLE0)      0   1.0000  0.0259  0.2263   0.1374     0.2002
# s(EKE0)       0   0.0366  1.0000  0.1266   0.0377     0.0862
# s(Sal0)       0   0.1182  0.0449  1.0000   0.4449     0.2912
# s(Temp0)      0   0.0694  0.0211  0.3406   1.0000     0.2363
# s(VelMag0)    0   0.1570  0.0689  0.3295   0.2374     1.0000
