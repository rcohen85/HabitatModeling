...
```
Looks like might have a pattern: Temp0Lag56, Temp700, Sal0Lag28, Sal700Lag7, VelMag0Lag56,
  VelMag700Lag56, VelAsp0Lag56, VelAsp700Lag42, SSH0, Chl0Lag56, FSLE0Lag28, GSDist

Looks like doesn't have pattern: FSLE0Lag28, GSLatLag28, Slope, Aspect
...
```
Removing Salinity at 700 because collinear with temp
Removing SSH because v collinear with temp, salinity
Removing FSLE, GSLa, Slope, Aspect because they don't seem to follow a trend (graphs above)
