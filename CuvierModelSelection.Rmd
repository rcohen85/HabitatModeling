...
```
Plots that look like there might be a preference: Temp0?, Temp700Lag42?, Sal0Lag56, Sal700Lag42?, VelMag0Lag42,
  VelMag700Lag42?, VelAsp0, VelAsp700Lag56?, SSH0Lag28, Chl0Lag14, GSDist?, Slope, Aspect

Plots that look like no preference: VelAsp0, Chl0Lag14, FSLE0Lag56, GSLatLag7



```{r checkVIF}
# calculate VIF for each of the variables desired in the full model
colMod = glm(Pres~Temp0
             +Temp700Lag42
             +Sal0Lag56
             # +Sal700Lag42
             +VelMag0Lag42 
...
Removing GSDist because highly collinear with Temp700, Sal700, SSH
Removing Sal700 because collinear with Temp700 and SSH
