...
Covars to start in full model: Temp0Lag14 
                                Temp100
                                Sal0Lag56 
                                Sal100Lag42
                                VelMag0Lag7 
...
```
Looks like there may be a trend: Temp0Lag14, Temp100, Sal0Lag56, Sal100Lag42, VelAsp0Lag56?, VelAsp100Lag56?, SSH0, Chl0, GSDist
  
Looks like there is no trend: VelMag0Lag7, VelMag100, FSLE, GSLatLag14, Slope, Aspect

**None of these have a super clear trend



```{r checkVIF}
# calculate VIF for each of the variables desired in the full model
colMod = glm(Pres~Temp0Lag14
             # +Temp100
             +Sal0Lag56
             +Sal100Lag42
             # +VelMag0Lag7 
...
```
At 100m, Temp is collinear with salinity, SSH, and GSDist
Remove Temp100 so that we can keep the rest of these variables in the model
