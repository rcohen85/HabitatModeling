...
# sites = c("HZ","BC","WC","BS")
# smoothVarList = list(c("Chl0","Sal200","FSLE0"),
#                       c("Chl0","Sal0","Sal200","FSLE0"),
#                       c("Chl0","Sal0","Sal200","FSLE0"),
#                       c("Chl0","Sal200","FSLE0"))
# knotList = list(c(0.5,0.5,0.5),
#                       c(0.5,0.5,0.5,0.5),
#                       c(0.5,0.5,0.5,0.5),
#                       c(0.5,0.5,0.5))
# linVarList = list(c(),
...
#       eval(parse(text=paste('S_',unlist(smoothVarList[j])[i],'= mSpline(modDF$',unlist(smoothVarList[j])[i],',knots=quantile(modDF$',unlist(smoothVarList[j])[i],',probs=unlist(knotList[j])[i]),Boundary.knots=c(min(modDF$',unlist(smoothVarList[j])[i],'),max(modDF$',unlist(smoothVarList[j])[i],')),periodic=TRUE)',sep="")))
#     } else {
#       eval(parse(text=paste('S_',unlist(smoothVarList[j])[i],'= mSpline(modDF$',unlist(smoothVarList[j])[i],',knots=quantile(modDF$',unlist(smoothVarList[j])[i],',probs=unlist(smoothVarList[j])[i]),Boundary.knots=c(min(modDF$',unlist(smoothVarList[j])[i],'),max(modDF$',unlist(smoothVarList[j])[i],')))',sep="")))
#     }
#     
