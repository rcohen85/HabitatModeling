...
data = data.frame(read.csv('E:/ModelingCovarData/Master_DFs/True_masterDF.csv'))
lagID = 41 
...
## THE FOLLOWING IS COPIED AND PASTED FROM BLAINVILLE'S, MODIFY FOR TRUE'S BEFORE RUNNING
