...
#               para s(CEddyDist0) s(EKE0) s(Chl0) s(Sal0) s(SSH0) s(Temp0)
# para             1        0.0000  0.0000  0.0000  0.0000  0.0000   0.0000
# s(CEddyDist0)    0        1.0000  0.0230  0.0404  0.1824  0.1974   0.1164
# s(EKE0)          0        0.0403  1.0000  0.0086  0.1266  0.0496   0.0377
# s(Chl0)          0        0.1138  0.0113  1.0000  0.3332  0.6354   0.5345
# s(Sal0)          0        0.1899  0.0449  0.1790  1.0000  0.6840   0.4449
# s(SSH0)          0        0.1906  0.0298  0.2239  0.4942  1.0000   0.6452
# s(Temp0)         0        0.0989  0.0211  0.2647  0.3406  0.4541   1.0000
...
#                 para s(CEddyDist0) s(EKE0) s(Chl0) s(Sal0) s(Temp0)
# para             1        0.0000  0.0000  0.0000  0.0000   0.0000
# s(CEddyDist0)    0        1.0000  0.0230  0.0404  0.1824   0.1164
# s(EKE0)          0        0.0403  1.0000  0.0086  0.1266   0.0377
# s(Chl0)          0        0.1138  0.0113  1.0000  0.3332   0.5345
# s(Sal0)          0        0.1899  0.0449  0.1790  1.0000   0.4449
# s(Temp0)         0        0.0989  0.0211  0.2647  0.3406   1.0000

# Temp0 concurved w Chlo
# removing Chl0
...
#                 para s(CEddyDist0) s(EKE0) s(Sal0) s(Temp0)
# para             1        0.0000  0.0000  0.0000   0.0000
# s(CEddyDist0)    0        1.0000  0.0230  0.1824   0.1164
# s(EKE0)          0        0.0403  1.0000  0.1266   0.0377
# s(Sal0)          0        0.1899  0.0449  1.0000   0.4449
# s(Temp0)         0        0.0989  0.0211  0.3406   1.0000
