...
for (j in 1:length(sites)){
  ...
  if (sum(which(weeklyDF$Pres[siteInd]>0))>10){
    ...
    BlockMod = glm(Pres~bs(Chl0) # include all terms in smoothVarList above!!
                   + bs(EKE0)
                   + bs(FSLE0)
                   + bs(Sal0)
                   + bs(SSH0)
...
dispMod = glm(Pres~bs(Chl0) # include all terms in smoothVarList above!!
              + bs(EKE0)
              + bs(FSLE0)
              + bs(Sal0)
              + bs(SSH0)
...
# 
# data:  dispMod
# z = 5.0111, p-value = 5.413e-07
# alternative hypothesis: true dispersion is not equal to 1
# sample estimates:
#   dispersion 
# 40.34977  

# data are qutie overdispersed, will use Tweedie family
modFam=tw

# run full model
weekMod = gam(Pres ~ s(Chl0,bs="ts",k=4)
              + s(EKE0,bs="ts",k=4)
              + s(FSLE0,bs="ts",k=4)
              + s(Sal0,bs="ts",k=4)
              + s(SSH0,bs="ts",k=4)
...
#             para s(Chl0) s(EKE0) s(FSLE0) s(Sal0) s(SSH0) s(Temp0) s(VelAsp0)
# para          1  0.0000  0.0000   0.0000  0.0000  0.0000   0.0000     0.0000
# s(Chl0)       0  1.0000  0.0113   0.0259  0.3332  0.6354   0.5345     0.1052
# s(EKE0)       0  0.0086  1.0000   0.0366  0.1266  0.0496   0.0377     0.0427
# s(FSLE0)      0  0.0457  0.0259   1.0000  0.2263  0.1687   0.1374     0.1548
# s(Sal0)       0  0.1790  0.0449   0.1182  1.0000  0.6840   0.4449     0.2632
# s(SSH0)       0  0.2239  0.0298   0.1005  0.4942  1.0000   0.6452     0.2678
# s(Temp0)      0  0.2647  0.0211   0.0694  0.3406  0.4541   1.0000     0.1823
# s(VelAsp0)    0  0.0670  0.0221   0.1378  0.3904  0.2285   0.2782     1.0000
...
#             para s(Chl0) s(EKE0) s(FSLE0) s(Sal0) s(Temp0) s(VelAsp0)
# para          1  0.0000  0.0000   0.0000  0.0000   0.0000     0.0000
# s(Chl0)       0  1.0000  0.0113   0.0259  0.3332   0.5345     0.1052
# s(EKE0)       0  0.0086  1.0000   0.0366  0.1266   0.0377     0.0427
# s(FSLE0)      0  0.0457  0.0259   1.0000  0.2263   0.1374     0.1548
# s(Sal0)       0  0.1790  0.0449   0.1182  1.0000   0.4449     0.2632
# s(Temp0)      0  0.2647  0.0211   0.0694  0.3406   1.0000     0.1823
# s(VelAsp0)    0  0.0670  0.0221   0.1378  0.3904   0.2782     1.0000

# Chl0 problematic w Temp0
# taking out Chl0
...
#             para s(EKE0) s(FSLE0) s(Sal0) s(Temp0) s(VelAsp0)
# para          1  0.0000   0.0000  0.0000   0.0000     0.0000
# s(EKE0)       0  1.0000   0.0366  0.1266   0.0377     0.0427
# s(FSLE0)      0  0.0259   1.0000  0.2263   0.1374     0.1548
# s(Sal0)       0  0.0449   0.1182  1.0000   0.4449     0.2632
# s(Temp0)      0  0.0211   0.0694  0.3406   1.0000     0.1823
# s(VelAsp0)    0  0.0221   0.1378  0.3904   0.2782     1.0000
